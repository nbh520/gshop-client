        ...
        <form @submit.prevent="login">
          <div :class="{on:loginWay}">
            <section class="login_message">
              ...
              <button :disabled="!rightPhone" class="get_verification" :class="{right_phone:rightPhone}" @click.prevent="getCode">{{computeTime>0 ? `${computeTime}s已发送` : '获取验证码'}}</button>
            </section>
...
export default {
  data() {
    return {
      loginWay: true, //true 代表短信登录， false：密码登录
      phone: "", //手机号
      code: "", //短信验证码
      computeTime: "", //验证码发送计时
